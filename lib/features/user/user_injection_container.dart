...
import 'package:chitter_chatter/features/user/data/data_sources/remote/user_remote_data_source_impl.dart';
import 'package:chitter_chatter/features/user/data/repository/user_repository_impl.dart';
import 'package:chitter_chatter/features/user/domain/repository/user_repository.dart';
import 'package:chitter_chatter/features/user/domain/usecases/credential/get_current_uid_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/credential/is_sign_in_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/credential/sign_in_with_phone_number_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/credential/sign_out_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/credential/verify_phone_number_usecsae.dart';
import 'package:chitter_chatter/features/user/domain/usecases/user/create_user_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/user/get_all_users_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/user/get_device_number_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/user/get_device_number_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/user/get_single_user_usecase.dart';
import 'package:chitter_chatter/features/user/domain/usecases/user/update_user_usecase.dart';
...
import 'package:chitter_chatter/features/user/presentation/cubit/get_device_number/get_device_number_cubit.dart';
...
import 'package:chitter_chatter/main_injection_container.dart';
